...
@DisplayName("DequeImpl simple testing")
class DequeImplTest {

    @Test
    void insertLeftAndRemoveLeft() {
        DequeImpl<String> deque = new DequeImpl<>(5);
        deque.insertLeft("a");
        deque.insertLeft("b");
        deque.insertLeft("c");
        deque.insertLeft("d");
    ...
    @ParameterizedTest
    @MethodSource("dataProviderForIsFull")
    @DisplayName("isFull - expected true")
    void isFull(Deque<?> deque) {
    ...
    public static Stream<Arguments> dataProviderForSize() {
        ...
        for (int i = 0; i < arguments.length; i++) {
            ...
            DequeImpl<Integer> deque = new DequeImpl<>(randomMaxSize);
    ...
    public static Stream<Arguments> dataProviderForIsFull() {
